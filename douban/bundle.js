...
var Rating = function (_Component) {
  ...
  function Rating(props) {
    ...
    _this.state = {};
    _this.getActiveStar = _this.getActiveStar.bind(_this);
    return _this;
  }

  _createClass(Rating, [{
    key: 'getActiveStar',
    value: function getActiveStar() {
    ...
    value: function render() {
      var items = [];
      var star = 5;
      var active = this.getActiveStar();
      for (var i = 0; i < active; i++) {
        items.push(_react2.default.createElement('i', { key: i, className: 'icon-font icon-star-full active-star' }));
      }
      for (var j = active; j < star; j++) {
        items.push(_react2.default.createElement('i', { key: j, className: 'icon-font icon-star-full normal-star' }));
      }
      return items;
    }
  }]);
...
var Wrapper = function (_Component) {
  ...
  _createClass(Wrapper, [{
    ...
    key: 'render',
    value: function render() {
      var goTopClassName = this.state.isGoTopShow ? ' show' : '';
      return _react2.default.createElement(
        'div',
        { className: this.props.className, onScroll: this.handleScroll, ref: this.myRef },
        this.props.children,
        _react2.default.createElement('a', { className: 'go-top icon-font icon-circle-up' + goTopClassName, onClick: this.goTop, href: '#' })
      );
    }
  }]);
  ...
  _createClass(Search, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement('i', { className: 'icon-font icon-search' }),
        _react2.default.createElement('input', { type: 'text', className: 'search', placeholder: this.props.placeholder, onChange: this.handleChange }),
        _react2.default.createElement(
          'button',
          { className: 'search-btn', onClick: function onClick() {
              return _this2.props.search(_this2.state.text);
            } },
          '\u641C\u7D22'
        )
      );
...
var Genres = function (_Component) {
  ...
  _createClass(Genres, [{
    key: 'render',
    value: function render() {
      return this.props.genres.map(function (genre, index) {
        return _react2.default.createElement(
          'a',
          { key: index, href: 'javascript:;', className: 'genres' },
          genre
        );
      });
    }
...
*/
var ba=__webpack_require__(8),ea=__webpack_require__(0),m=__webpack_require__(14),A=__webpack_require__(3),C=__webpack_require__(9),fa=__webpack_require__(15),ha=__webpack_require__(16),ja=__webpack_require__(17),ka=__webpack_require__(18);
...
var _bookList = __webpack_require__(39);

var _bookList2 = _interopRequireDefault(_bookList);

var _movieList = __webpack_require__(42);

var _movieList2 = _interopRequireDefault(_movieList);

var _musicList = __webpack_require__(44);

var _musicList2 = _interopRequireDefault(_musicList);

var _itemPage = __webpack_require__(45);
...
var App = function (_Component) {
  ...
  function App(props) {
    ...
    _this.state = {
      currentTab: _conf2.default.BOOK,
      isItemShow: false,
      item: null
    };
  ...
  _createClass(App, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        'div',
        { className: 'app' },
        _react2.default.createElement(_bookList2.default, { currentTab: this.state.currentTab, onClick: this.showItem }),
        _react2.default.createElement(_movieList2.default, { currentTab: this.state.currentTab, onClick: this.showItem }),
        _react2.default.createElement(_musicList2.default, { currentTab: this.state.currentTab, onClick: this.showItem }),
        _react2.default.createElement(_itemPage2.default, { isShow: this.state.isItemShow, item: this.state.item,
          currentTab: this.state.currentTab, onClose: this.hideItem }),
        _react2.default.createElement(
          'nav',
          { className: 'nav' },
          _react2.default.createElement(
            'ul',
            { className: 'nav-list' },
            _react2.default.createElement(_tab2.default, { name: '\u56FE\u4E66', isActive: this.state.currentTab === _conf2.default.BOOK,
              className: 'icon-book', changeTab: function changeTab() {
                return _this2.changeTab(_conf2.default.BOOK);
              } }),
            _react2.default.createElement(_tab2.default, { name: '\u7535\u5F71', isActive: this.state.currentTab === _conf2.default.MOVIE,
              className: 'icon-movie', changeTab: function changeTab() {
                return _this2.changeTab(_conf2.default.MOVIE);
              } }),
            _react2.default.createElement(_tab2.default, { name: '\u97F3\u4E50', isActive: this.state.currentTab === _conf2.default.MUSIC,
              className: 'icon-cd', changeTab: function changeTab() {
                return _this2.changeTab(_conf2.default.MUSIC);
              } })
          )
        )
      );
...
var _fetchJsonp = __webpack_require__(4);
...
var _rating = __webpack_require__(2);
...
var BookList = function (_Component) {
  ...
  _createClass(BookList, [{
    ...
    // 查询书籍，如果没有关键字，则按tag=novel查询；有则按关键字查询。

  }, {
    key: 'getData',
    value: function getData(start, searchParam) {
      var _this2 = this;

      if (this.state.total > 0 && start >= this.state.total) {
        return;
      }
      ...
      (0, _fetchJsonp2.default)(url).then(function (response) {
        ...
        return _this2.setState(function (prevState) {
          return {
            books: prevState.books.concat(json.books),
            nextStart: json.start + json.count,
            total: json.total,
    ...
    value: function getNextPage() {
      this.getData(this.state.nextStart, this.state.searchParam);
    }

    // 按关键字搜索书籍，每次点击搜索都会清空books数组
    ...
    value: function renderBooks() {
      ...
      var list = this.state.books.map(function (book) {
        return _react2.default.createElement(
          'li',
          { className: 'item', key: book.id, onClick: function onClick() {
              return _this3.props.onClick(book);
            } },
          _react2.default.createElement(
            'div',
            { className: 'image' },
            _react2.default.createElement('img', { src: book.images.small, alt: book.title })
          ),
          _react2.default.createElement(
            'div',
            { className: 'info' },
            ...
            _react2.default.createElement(
              'p',
              { className: 'rating' },
              _react2.default.createElement(_rating2.default, { rating: book.rating.average }),
              _react2.default.createElement(
                'span',
                { className: 'num' },
                book.rating.average
    ...
    key: 'render',
    value: function render() {
      var placeholder = '书名、作者、ISBN';
      var className = this.props.currentTab === _conf2.default.BOOK ? 'tab' : 'tab hide';
      return _react2.default.createElement(
        _wrapper2.default,
        { className: className, getNextPage: this.getNextPage },
        _react2.default.createElement(_search2.default, { placeholder: placeholder, search: this.search }),
        this.renderBooks()
      );
    }
  }]);
...
var _genres = __webpack_require__(20);
...
var MovieList = function (_Component) {
  ...
  _createClass(MovieList, [{
    ...
    // 查询电影，如果没有关键字，则按top250查询；有则按关键字查询。
    ...
    value: function getData(start, searchParam) {
      ...
      if (!searchParam || searchParam.trim() === '') {
        ...
        url = 'https://api.douban.com/v2/movie/search?q=' + searchParam + '&start=' + start;
      }
      ...
      (0, _fetchJsonp2.default)(url).then(function (response) {
        ...
        return _this2.setState(function (prevState) {
          return {
            movies: prevState.movies.concat(json.subjects),
            nextStart: json.start + json.count,
            total: json.total,
            searchParam: searchParam
          };
    ...
    value: function renderMovies() {
      ...
      var list = this.state.movies.map(function (movie) {
        return _react2.default.createElement(
          'li',
          { className: 'item', key: movie.id, onClick: function onClick() {
              return _this3.props.onClick(movie);
            } },
          _react2.default.createElement(
            'div',
            { className: 'image' },
            _react2.default.createElement('img', { src: movie.images.small, alt: movie.title })
          ),
          _react2.default.createElement(
            'div',
            { className: 'info' },
            ...
            _react2.default.createElement(
              'p',
              { className: 'rating' },
              _react2.default.createElement(_rating2.default, { rating: movie.rating.average }),
              _react2.default.createElement(
                'span',
                { className: 'num' },
            ...
            _react2.default.createElement(
              'p',
              { className: 'meta' },
              _react2.default.createElement(_genres2.default, { genres: movie.genres })
            ),
            _react2.default.createElement(
              'p',
              { className: 'meta' },
              movie.casts.map(function (cast) {
                return cast.name;
              }).join(', ')
            ),
            _react2.default.createElement(
    ...
    key: 'render',
    value: function render() {
      var placeholder = '电影、影人、影院、电视剧';
      var className = this.props.currentTab === _conf2.default.MOVIE ? 'tab' : 'tab hide';
      return _react2.default.createElement(
        _wrapper2.default,
        { className: className, getNextPage: this.getNextPage },
        _react2.default.createElement(_search2.default, { placeholder: placeholder, search: this.search }),
...
var MusicList = function (_Component) {
  ...
  function MusicList(props) {
    ...
    _this.renderMusic = _this.renderMusic.bind(_this);
    _this.search = _this.search.bind(_this);
    _this.getData = _this.getData.bind(_this);
    _this.getNextPage = _this.getNextPage.bind(_this);
    return _this;
  ...
  _createClass(MusicList, [{
    key: 'componentDidMount',
    value: function componentDidMount() {
      // 第一次查询音乐，默认tag=chinese
      this.getData(0, '');
    }

    // 查询音乐，如果没有关键字，则按tag=chinese查询；有则按关键字查询。
    ...
    value: function getData(start, searchParam) {
      ...
      (0, _fetchJsonp2.default)(url).then(function (response) {
        ...
        return _this2.setState(function (prevState) {
          return {
            musics: prevState.musics.concat(json.musics),
            nextStart: json.start + json.count,
            total: json.total,
            searchParam: searchParam
          };
    ...
    value: function renderMusic() {
      ...
      var list = this.state.musics.map(function (music) {
        return _react2.default.createElement(
          'li',
          { className: 'item', key: music.id, onClick: function onClick() {
              return _this3.props.onClick(music);
            } },
          _react2.default.createElement(
            'div',
            { className: 'image' },
            _react2.default.createElement('img', { src: music.image, alt: music.title })
          ),
          _react2.default.createElement(
            'div',
            { className: 'info' },
            ...
            _react2.default.createElement(
              'p',
              { className: 'rating' },
              _react2.default.createElement(_rating2.default, { rating: music.rating.average }),
              _react2.default.createElement(
                'span',
                { className: 'num' },
    ...
    key: 'render',
    value: function render() {
      var placeholder = '唱片名、表演者、条码、ISRC';
      var className = this.props.currentTab === _conf2.default.MUSIC ? 'tab' : 'tab hide';
      return _react2.default.createElement(
        _wrapper2.default,
        { className: className, getNextPage: this.getNextPage },
        _react2.default.createElement(_search2.default, { placeholder: placeholder, search: this.search }),
...
var _movie = __webpack_require__(48);

var _movie2 = _interopRequireDefault(_movie);

var _music = __webpack_require__(50);
...
var ItemPage = function (_Component) {
  ...
  function ItemPage(props) {
    ...
    var _this = _possibleConstructorReturn(this, (ItemPage.__proto__ || Object.getPrototypeOf(ItemPage)).call(this, props));
  ...
  _createClass(ItemPage, [{
    ...
    value: function renderContent() {
      var content = {
        book: _react2.default.createElement(_book2.default, { item: this.props.item }),
        movie: _react2.default.createElement(_movie2.default, { item: this.props.item }),
        music: _react2.default.createElement(_music2.default, { item: this.props.item })
      };
      return content[this.props.currentTab];
    }
  }, {
    key: 'getTitle',
    value: function getTitle() {
      ...
      return title[this.props.currentTab];
    }
  }, {
    key: 'render',
    value: function render() {
      return this.props.isShow ? _react2.default.createElement(
        'div',
        { className: 'item-page', onScroll: null },
        _react2.default.createElement(
          'div',
          { className: 'toolbar toolbar-fixed' },
          _react2.default.createElement(
            'a',
            { href: 'javascript:;', className: 'btn-icon', onClick: this.props.onClose },
            _react2.default.createElement('i', { className: 'icon-font icon-arrow-left2' })
          ),
          _react2.default.createElement(
            'span',
            null,
...
var Book = function (_Component) {
  ...
  _createClass(Book, [{
    key: 'renderCatalog',
    value: function renderCatalog(book) {
      var hasCatalog = book.catalog !== '';
      var catalog = hasCatalog ? _react2.default.createElement(
        'div',
        { className: 'intro' },
        _react2.default.createElement(
          'h2',
        ...
        _react2.default.createElement('p', { dangerouslySetInnerHTML: { __html: book.catalog.replace(/\n/g, '<br>') } })
      ) : null;
      return catalog;
    }
  }, {
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement('p', { dangerouslySetInnerHTML: { __html: book.summary.replace(/\n/g, '<br>') } })
        ),
        this.renderCatalog(book)
      );
    }
  }]);
...
var Movie = function (_Component) {
  ...
  _createClass(Movie, [{
    ...
    value: function componentDidMount() {
      ...
      var url = 'https://api.douban.com/v2/movie/subject/' + movie.id;
      (0, _fetchJsonp2.default)(url).then(function (response) {
        return response.json();
      }).then(function (json) {
    ...
    key: 'renderCasts',
    value: function renderCasts(casts) {
      return casts.map(function (cast) {
        return _react2.default.createElement(
          'li',
          { key: cast.id, className: 'item-cast' },
          _react2.default.createElement('img', { className: 'item-cast-image', src: cast.avatars.small, alt: cast.name }),
          _react2.default.createElement(
            'span',
            null,
            cast.name
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              'ul',
              { className: 'casts' },
              this.renderCasts(movie.directors)
            )
          )
        ),
        _react2.default.createElement(
...
var Music = function (_Component) {
  ...
  _createClass(Music, [{
    key: 'renderTracks',
    value: function renderTracks(tracks) {
      return tracks.map(function (track, i) {
        return _react2.default.createElement('p', { key: i, dangerouslySetInnerHTML: { __html: track.replace(/\n/g, '<br>') } });
      });
    }
  }, {
    key: 'render',
    value: function render() {
      var music = this.props.item;
      return _react2.default.createElement(
        'div',
        { className: 'card' },
        _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              'p',
              { className: 'meta' },
              music.attrs.publisher.join(', ')
            ),
            _react2.default.createElement(
              'p',
              { className: 'meta' },
              music.attrs.pubdate.join(', ')
            )
          )
        ),
        _react2.default.createElement(
          ...
          this.renderTracks(music.attrs.tracks)
        )
      );
    }
  }]);
...
var Tab = function (_Component) {
  ...
  _createClass(Tab, [{
    key: 'render',
    value: function render() {
      var itemClassName = 'nav-item' + (this.props.isActive ? ' active' : '');
      var iconClassName = 'icon-font ' + this.props.className;
      return _react2.default.createElement(
        'li',
        { className: itemClassName, onClick: this.props.changeTab },
